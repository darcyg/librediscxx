...
private:
  struct delete_data : boost::detail::tss_cleanup_function
  {
  ...
  struct custom_cleanup_function_ptr : boost::detail::tss_cleanup_function
  {
  private:
  ...
  struct custom_cleanup_function_obj : boost::detail::tss_cleanup_function
  {
  private:
...
public:
  ...
  ~thread_specific_ptr()
  {
    boost::detail::set_tss_data(this,
      boost::shared_ptr<boost::detail::tss_cleanup_function>(), 0, true);
  }
  ...
  T * release()
  {
    T * const temp = get();
    boost::detail::set_tss_data(this,
      boost::shared_ptr<boost::detail::tss_cleanup_function>(), 0, false);
    return temp;
  }

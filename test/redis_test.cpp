...
#define DUMP_TEST_RESULT()\
  ...
  int basic_test(RedisBase2& r)
  {
    ...
    //  VERIFY(i == 1);
    //  VERIFY_MSG(r.lpush("c", "1.0", &i), r);
    //  VERIFY(i == 1);
    //  VERIFY_MSG(r.sadd("d", "2.0", &i), r);
    //  VERIFY(i == 1);
    //  VERIFY_MSG(r.zadd("e", 3.0, "3.0", &i), r);
    //  VERIFY(i == 1);
    ...
    //  VERIFY_MSG(r.lpush("c2", "c2", &i), r);
    //  VERIFY(i == 1);
    //  VERIFY_MSG(r.sadd("d2", "d2", &i), r);
    //  VERIFY(i == 1);
    //  VERIFY_MSG(r.zadd("e2", 3.0, "e2", &i), r);
    //  VERIFY(i == 1);

    //  VERIFY(!r.sort("c2", NULL, &mb));
    //  VERIFY(!r.sort("d2", NULL, &mb));
    //  VERIFY(!r.sort("e2", NULL, &mb));
